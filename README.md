...
1. **google-services.json 프로젝트에 넣기**
    -   firebase의 프로젝트 세팅에서 google-services.json을 다운받아 Unity의 Assets폴더에 넣어준다.

    ![google-services.json 파일 다운 받는 법](./Image/google-service.png)

2.  **Firebase Unity SDK 다운로드**
